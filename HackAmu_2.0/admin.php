...
?>
    <div class="abt" style="position: absolute; top:12%;left:5%; ">
      <img  id="bulb" src="img/logo.png"   alt="logo"  width="500px"   height="500px;" 
      onmouseover="this.src='img/logo.png';"  onmouseout="this.src='img/logo.png';" style="position:relative; top:-11%; left:21% ;  border="" />
