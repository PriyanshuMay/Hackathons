...
<body background="img/back.jpg">
  <div class="abt_index" id ="abt_visibility" style="position: absolute; top:15%;left:20%; ">
      <img  id="bulb_index" src="img/logo.png" title="Natioanl Toll Free No" width="400px"   height="400px;"
      onmouseover="this.src='img/logo.png';"  onmouseout="this.src='img/call.jpg';" style="position:relative; top:-5%; left:25% ;  border="" />
